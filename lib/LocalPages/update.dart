...
class _UpdateState extends State<Update> {
  ...
  void initState() {
    ...
    for (int i = 0; i < activities.length; i++) {
      desccontrol.add(TextEditingController(text: widget.activities[i].desc));
      namecontrol.add(TextEditingController(text: widget.activities[i].name));
    }
    addval = widget.event;
  }
